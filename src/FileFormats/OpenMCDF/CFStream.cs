...
{
    /// <summary>
    /// OLE structured storage <see cref="T:Workshell.FileFormats.OpenMCDF.CFStream">stream</see> Object
    ...
    internal class CFStream : CFItem
    {
        ...
        /// begin copying bytes to the current <see cref="T:Workshell.FileFormats.OpenMCDF.CFStream">CFStream</see>. </param>
        /// <param name="count">The number of bytes to be written to the current <see cref="T:Workshell.FileFormats.OpenMCDF.CFStream">CFStream</see> </param>
        /// <remarks>Current stream will be extended to receive data buffer over 
        /// its current size.</remarks>
        ...
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDisposedException">
