...
namespace Workshell.FileFormats.OpenMCDF
{
    ...
    internal class CompoundFile : IDisposable
    {
        ...
        /// <param name="configFlags">Set <see cref="T:Workshell.FileFormats.OpenMCDF.CFSConfiguration">configuration</see> parameters for the new compound file</param>
        /// <example>
        /// <code>
        /// 
        ///     byte[] b = new byte[10000];
        ...
        ///  </code>
        ///  </example>
        ///  <exception cref="T:Workshell.FileFormats.OpenMCDF.CFException">Raised when trying to open a non-seekable stream</exception>
        ///  <exception cref="T:Workshell.FileFormats.OpenMCDF.CFException">Raised stream is null</exception>
        ...
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFException">Raised if destination file is not seekable</exception>
        ...
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFException">Raised if destination stream is not seekable</exception>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDisposedException">Raised if Compound File Storage has been already disposed</exception>
        /// <example>
        /// <code>
        ...
        /// <summary>
        /// Close the Compound File object <see cref="T:Workshell.FileFormats.OpenMCDF.CompoundFile">CompoundFile</see> and
        ...
        /// any operation invoked on them will produce a <see cref="T:Workshell.FileFormats.OpenMCDF.CFDisposedException">CFDisposedException</see>.
        /// </remarks>
        /// </summary>
        /// <example>
        /// <code>
