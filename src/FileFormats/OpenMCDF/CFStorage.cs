...
using Workshell.FileFormats.OpenMCDF.RedBlackTree;
...
namespace Workshell.FileFormats.OpenMCDF
{
    ...
    /// </summary>
    /// <param name="item">Currently visited <see cref="T:Workshell.FileFormats.OpenMCDF.CFItem">item</see></param>
    /// <example>
    /// <code>
    /// 
    ...
    internal class CFStorage : CFItem
    {
        ...
        /// <summary>
        /// Create a new child stream inside the current <see cref="T:Workshell.FileFormats.OpenMCDF.CFStorage">storage</see>
        /// </summary>
        /// <param name="streamName">The new stream name</param>
        /// <returns>The new <see cref="T:Workshell.FileFormats.OpenMCDF.CFStream">stream</see> reference</returns>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDuplicatedItemException">Raised when adding an item with the same name of an existing one</exception>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDisposedException">Raised when adding a stream to a closed compound file</exception>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFException">Raised when adding a stream with null or empty name</exception>
        /// <example>
        /// <code>
        /// 
        ...
        /// <summary>
        /// Get a named <see cref="T:Workshell.FileFormats.OpenMCDF.CFStream">stream</see> contained in the current storage if existing.
        /// </summary>
        /// <param name="streamName">Name of the stream to look for</param>
        /// <returns>A stream reference if existing</returns>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDisposedException">Raised if trying to delete item from a closed compound file</exception>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFItemNotFound">Raised if item to delete is not found</exception>
        /// <example>
        /// <code>
        ...
        /// <returns>Reference to the new <see cref="T:Workshell.FileFormats.OpenMCDF.CFStorage">storage</see></returns>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDuplicatedItemException">Raised when adding an item with the same name of an existing one</exception>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDisposedException">Raised when adding a storage to a closed compound file</exception>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFException">Raised when adding a storage with null or empty name</exception>
        /// <example>
        /// <code>
        /// 
        ///  String filename = "A_NEW_COMPOUND_FILE_YOU_CAN_WRITE_TO.cfs";
        ...
        /// </summary>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDisposedException">Raised when visiting items of a closed compound file</exception>
        /// <param name="action">User <see cref="T:Workshell.FileFormats.OpenMCDF.VisitedEntryAction">action</see> to apply to visited entities</param>
        ...
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFDisposedException">Raised if trying to delete item from a closed compound file</exception>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFItemNotFound">Raised if item to delete is not found</exception>
        /// <exception cref="T:Workshell.FileFormats.OpenMCDF.CFException">Raised if trying to delete root storage</exception>
