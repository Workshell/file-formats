...
namespace Workshell.FileFormats.OpenMCDF.Extensions
{
    internal static class CFStreamExtension
    {
        ...
        /// <summary>
        /// Return the current <see cref="T:Workshell.FileFormats.OpenMCDF.CFStream">CFStream</see> object 
        /// as a <see cref="T:System.IO.Stream">Stream</see> object.
        /// </summary>
        /// <param name="cfStream">Current <see cref="T:Workshell.FileFormats.OpenMCDF.CFStream">CFStream</see> object</param>
        ...
        /// <returns>A <see cref="T:Workshell.FileFormats.OpenMCDF.Extensions.OLEProperties.PropertySetStream">OLE Propertie stream</see></returns>
