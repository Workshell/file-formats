...
namespace Workshell.OpenMcdf
{
    /// <summary>
    /// Action to apply to  visited items in the OLE structured storage
    /// </summary>
    /// <param name="item">Currently visited <see cref="T:Workshell.OpenMcdf.CFItem">item</see></param>
    /// <example>
    /// <code>
    /// 
    ...
    internal class CFStorage : CFItem
    {
        ...
        /// <summary>
        /// Create a new child stream inside the current <see cref="T:Workshell.OpenMcdf.CFStorage">storage</see>
        /// </summary>
        /// <param name="streamName">The new stream name</param>
        /// <returns>The new <see cref="T:Workshell.OpenMcdf.CFStream">stream</see> reference</returns>
        /// <exception cref="T:Workshell.OpenMcdf.CFDuplicatedItemException">Raised when adding an item with the same name of an existing one</exception>
        /// <exception cref="T:Workshell.OpenMcdf.CFDisposedException">Raised when adding a stream to a closed compound file</exception>
        /// <exception cref="T:Workshell.OpenMcdf.CFException">Raised when adding a stream with null or empty name</exception>
        /// <example>
        /// <code>
        /// 
        ...
        /// <summary>
        /// Get a named <see cref="T:Workshell.OpenMcdf.CFStream">stream</see> contained in the current storage if existing.
        /// </summary>
        ...
        /// </summary>
        /// <param name="streamName">Name of the stream to look for</param>
        /// <param name="cfStream">Found <see cref="T:Workshell.OpenMcdf.CFStream"> if any</param>
        ...
        /// <returns>Reference to the new <see cref="T:Workshell.OpenMcdf.CFStorage">storage</see></returns>
        /// <exception cref="T:Workshell.OpenMcdf.CFDuplicatedItemException">Raised when adding an item with the same name of an existing one</exception>
        /// <exception cref="T:Workshell.OpenMcdf.CFDisposedException">Raised when adding a storage to a closed compound file</exception>
        /// <exception cref="T:Workshell.OpenMcdf.CFException">Raised when adding a storage with null or empty name</exception>
        /// <example>
        /// <code>
        /// 
        ///  String filename = "A_NEW_COMPOUND_FILE_YOU_CAN_WRITE_TO.cfs";
        ...
        /// </summary>
        /// <exception cref="T:Workshell.OpenMcdf.CFDisposedException">Raised when visiting items of a closed compound file</exception>
        /// <param name="action">User <see cref="T:Workshell.OpenMcdf.VisitedEntryAction">action</see> to apply to visited entities</param>
        ...
        /// <exception cref="T:Workshell.OpenMcdf.CFDisposedException">Raised if trying to delete item from a closed compound file</exception>
        /// <exception cref="T:Workshell.OpenMcdf.CFItemNotFound">Raised if item to delete is not found</exception>
        /// <exception cref="T:Workshell.OpenMcdf.CFException">Raised if trying to delete root storage</exception>
